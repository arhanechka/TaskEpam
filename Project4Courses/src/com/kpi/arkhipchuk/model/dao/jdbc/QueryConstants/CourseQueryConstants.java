...
public interface CourseQueryConstants {
    ...
    public static final String STUDENT_INSERT_FOR_JOIN_TO_NEW_COURSE = "INSERT INTO stud_course_mark (stud_course_mark.st_id, stud_course_mark.course_id) VALUES (?, ?);";
    public static final String TEACHER_SELECT_CURRENT_COURSES = "SELECT distinct co.course_id, co.course_name, co.course_status FROM course as co\n" +
            ...
            "WHERE isnull(scm.mark_id) AND tc.teacher_id = ?;";
    public static final String TEACHER_SELECT_LIST_OF_STUDENTS_FOR_CURRENT_COURSES = "SELECT * FROM student s\n" +
