...
public final class StudentQueryConstants {
    ...
    public static final String STUDENT_CREATE = "INSERT INTO student " +
            "(st_first_name, st_last_name, st_login, st_password, st_email) values (?, ?, ?, ?, ?);";
    public static final String STUDENT_DELETE = "DELETE FROM student WHERE st_id=?;";
    public static final String STUDENT_UPDATE = "UPDATE student " +
            "SET st_first_name = ?, st_last_name = ?, st_login = ?, st_password = ?, st_email = ?" +
            "WHERE st_id=?;";
    public static final String STUDENT_SELECT_BY_EMAIL_AND_PASSWORD = "SELECT * FROM student " +
            "WHERE st_email = ? AND st_password = ?";
    ...
    public static final String STUDENT_UPDATE_MARK_AND_COMMENT = "UPDATE stud_course_mark\n" +
        ...
        public static final String STUDENT_INSERT_NEW_STUDENT = "INSERT INTO student " +
                "(st_first_name, st_last_name, st_login, st_password, st_email) VALUES (?, ?, ?, ?, ?)";
        public static final String COURSES_HISTORY = "SELECT s.st_first_name, s.st_last_name, ma.mark_name, scm.comment " +
                "FROM student s, course as c \n" +
